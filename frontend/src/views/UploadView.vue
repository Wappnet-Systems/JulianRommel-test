<template>
  <div class="mx-auto">
    <div
      action=""
      class="flex flex-col items-center space-y-10 mt-32 max-w-md mx-auto"
    >
        ...
        <div class="flex flex-col">
          <label class="inline-flex items-center mt-3">
            <input
              ...
              checked
            /><span class="ml-2 text-jet">Freigabe</span>
          </label>
          <label class="inline-flex items-center mt-3">
            <input
              v-model="uploadTo"
              ...
              value="documents"
              class="form-radio h-5 w-5"
            /><span class="ml-2 text-jet">Dokument</span>
          </label>
        </div>
        <div>
          <input
            :disabled="uploadTo == 'documents'"
            id="client"
            type="text"
            list="clients"
            placeholder="Mandant"
      ...
      <progress
        ...
        class="w-full rounded bg-red-400"
      ></progress>
    </div>
  </div>
</template>
